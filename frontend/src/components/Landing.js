        ...
        resumes.map((item,index)=>{
          console.log(item)
                        return(
                            ...
                            <h5 className="text-center saved-res"><Link to={item.resumetype=="A" ? "/resume/"+item._id : "/resumeb/"+item._id }>{"Resume "+(index+1)}</Link> <span className="btn btn-dark"><a href={"https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://hackathon-rb.herokuapp.com/resume/"+item._id}>Get QR</a> </span> </h5>
